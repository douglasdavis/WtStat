...
b1j1b = reversed([34, 36, 38])
b2j1b = reversed([24, 22, 20])
b2j2b = reversed([34, 35, 38])
b3jpT = reversed([34, 36, 38])
...
for i, combo in enumerate(itertools.product(b1j1b, b2j1b, b2j2b, b3jpT, r2j2b_max)):
    ...
    dirname = "third_nbinscan90_{}_{}_{}_{}_{}_{}".format(str(i+108).zfill(4),
